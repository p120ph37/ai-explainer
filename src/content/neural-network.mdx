...
<Recognition title="Weighing factors in your head">

When deciding whether to go outside, you might weight "is it raining?" heavily negative, weight "do I have errands?" heavily positive, and weight "what's on TV?" slightly negative. Different weights, different decisions.
