...
<FlowDiagram
  ...
  steps={[
    { id: '1', label: 'Sample Batch', sublabel: 'Get text', icon: '📦' },
    { id: '2', label: 'Forward Pass', sublabel: 'Make predictions', icon: '➡️' },
    { id: '3', label: 'Compute Loss', sublabel: 'How wrong?', icon: '📉' },
    { id: '4', label: 'Backward Pass', sublabel: 'Find gradients', icon: '⬅️' },
    { id: '5', label: 'Update', sublabel: 'Adjust params', icon: '🔄' },
  ]}
...
- **GPT-5.1**: Trillions, exact figures undisclosed
