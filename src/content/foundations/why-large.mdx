...
The difference is scale. GPT-4 has roughly a trillion parameters compared to millions for a phone predictor. It was trained on trillions of words rather than a curated phrase list. It considers thousands of tokens of context rather than a few words.
