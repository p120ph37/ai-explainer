...
Different models learn different embeddings. GPT-4's embedding for "cat" is a completely different list of numbers than BERT's embedding for "cat." The spaces aren't compatible.
