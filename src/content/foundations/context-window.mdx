...
- GPT-3 (2020): 4,096 tokens (roughly 3,000 words)
- GPT-4 (2023): 8,192 or 32,768 tokens
- Claude 3 (2024): 200,000 tokens (roughly a 500-page book)
- Some models now claim 1 million+ tokens
