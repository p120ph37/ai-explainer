...
import { LayerStack, DiagramPlaceholder } from '../../app/components/diagrams/index.ts'
...
<DiagramPlaceholder
  toyId="perceptron-toy"
  title="Interactive Perceptron"
  description="Adjust weights and bias to see how a single neuron classifies inputs"
  icon="🔘"
/>
