...
<FlowDiagram
  ...
  steps={[
    { id: '1', label: 'New Message', sublabel: 'User input', icon: '💬' },
    { id: '2', label: 'Retrieve', sublabel: 'Relevant memories', icon: '🔍' },
    { id: '3', label: 'Construct', sublabel: 'Context + memories', icon: '📋' },
    { id: '4', label: 'Generate', sublabel: 'LLM response', icon: '🧠' },
    { id: '5', label: 'Store', sublabel: 'Update memories', icon: '💾' },
  ]}
...
<Citation type="docs" title="Conversation Management" source="OpenAI" url="https://platform.openai.com/docs/guides/conversation" />
</Sources>
