...
**You've seen this go viral.** The "How many r's in strawberry?" meme became a widespread demonstration of LLM limitations. Before understanding tokens, this seems like the AI is just "bad at counting." After understanding tokens, it's clear: the model might see "straw" + "berry" as two tokens. The letter-level information is literally hidden from it. It's not stupidity; it's architecture.
