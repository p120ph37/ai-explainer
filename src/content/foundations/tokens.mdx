...
import { TokenBoundaries, DiagramPlaceholder } from '../../app/components/diagrams/index.ts'
...
<DiagramPlaceholder
  toyId="tokenizer-demo"
  title="Interactive Tokenizer"
  description="Type text and see it split into tokens in real-time"
  icon="✂️"
/>
