...
The model had to "know" 150 immediately—no scratch work.
```
...
<Citation type="docs" title="Reasoning Models" source="OpenAI" url="https://platform.openai.com/docs/guides/reasoning" />
</Sources>
