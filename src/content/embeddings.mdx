...
<Recognition title="Concepts as neighbors">

Ask about "cats" and the model fluidly discusses "kittens," "felines," and "pets." It's not pattern-matching on the word "cat." It's working in a space where these concepts are neighbors.
