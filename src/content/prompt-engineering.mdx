...
<Recognition title="Rephrasing changed everything">
...
<Recognition title="Like asking a colleague">

Asking a colleague "can you help with the project?" gets different results than "can you review section 3 of the proposal by Thursday for clarity and flow?" LLMs respond similarly to specificity.
...
<Recognition title="Personal prompt templates">
