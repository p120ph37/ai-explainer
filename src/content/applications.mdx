...
<Recognition title="Each AI feels different">
...
→ [Guardrails in depth](/guardrails)
...
<Citation type="docs" title="Building with LLMs" source="Anthropic" url="https://docs.anthropic.com/en/docs/build-with-claude/overview" />
</Sources>
