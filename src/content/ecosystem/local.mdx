...
summary: Local models run on your hardware—private, offline, free per query. But they're fundamentally less capable than cloud frontier models, and optimizations can't close that gap.
category: Ecosystem
order: 5
prerequisites:
  - intro
...
If there were a way to run their models cheaply, they'd use it—their costs would drop. The fact that they need massive infrastructure tells you: **there's no hidden efficiency to unlock.**
...
**Privacy-sensitive tasks**: Medical notes, legal documents, personal data—never leaves your device.

**High-volume simple tasks**: Summarization, classification, extraction—where you'd pay too much for API calls.
