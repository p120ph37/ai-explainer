...
<FlowDiagram
  title="RAG Pipeline"
  steps={[
    { id: '1', label: 'User Question', sublabel: '"What\'s our refund policy?"', icon: '💬' },
    { id: '2', label: 'Embed Query', sublabel: 'Convert to vector', icon: '🔢' },
    { id: '3', label: 'Search', sublabel: 'Find similar docs', icon: '🔍' },
    { id: '4', label: 'Retrieve', sublabel: 'Get relevant chunks', icon: '📄' },
    { id: '5', label: 'Generate', sublabel: 'LLM + retrieved context', icon: '✨' },
  ]}
  direction="horizontal"
...
→ [Vector databases in depth](/vector-databases)
