...
GPT-3 has 175 billion parameters.<Footnote id={1} /> GPT-4 is estimated to be significantly larger, possibly over a trillion. For comparison: a typical smartphone keyboard predictor might have a few million. The jump from millions to hundreds of billions isn't just "bigger." It's the difference between suggesting the next word and writing a coherent essay on quantum physics.
