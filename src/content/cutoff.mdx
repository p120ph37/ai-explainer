...
<Recognition title="My knowledge was last updated...">
...
<Sources>
<Citation type="docs" title="Claude Model Documentation" source="Anthropic" url="https://docs.anthropic.com/en/docs/about-claude/models" />
<Citation type="article" title="What is a Knowledge Cutoff?" source="Hugging Face" url="https://huggingface.co/blog" />
</Sources>
