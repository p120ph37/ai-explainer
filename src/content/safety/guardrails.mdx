...
<FlowDiagram
  ...
  steps={[
    { id: '1', label: 'User Input', sublabel: 'Message received', icon: '💬' },
    { id: '2', label: 'Input Guards', sublabel: 'Check & filter', icon: '🛡️' },
    { id: '3', label: 'Pass/Block', sublabel: 'Decision point', icon: '⚖️' },
    { id: '4', label: 'To Model', sublabel: 'If approved', icon: '🧠' },
  ]}
...
→ [Prompt injection and security](/security)
...
<Citation type="docs" title="Content Moderation" source="OpenAI" url="https://platform.openai.com/docs/guides/moderation" />
</Sources>
